...
const apiMaps = [{
  ...
  path: ["/auth/delete-user", "/auth/delete-user/:appType"],
  method: "DELETE",
  input: {
    transform: function (req) {
      return {
...
{
  path: ["/util/get-user", "/util/get-user/:appType"],
  method: "POST",
  input: {
    examples: [{
  ...
  path: ["/util/get-verification", "/util/get-verification/:appType"],
  method: "POST",
  input: {
    examples: [{
  ...
  path: ["/auth/create-user", "/auth/create-user/:appType"],
  method: "POST",
  input: {
    examples: [{
      path: "/util/create-user/backoffice",
      body: {
        holderId: "5d2c53f6cbc31a7849913058",
        phoneNumber: "+84999999999",
        firstName: "Doe",
