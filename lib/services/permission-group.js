...
function PermissionGroup(params) {
  ...
  this.createPermissionGroup = function ({
    name,
    permissions,
    appType
  }) {
    ...
    return getOnePermissionGroupByNameAndAppType({
      name,
      appTypeConvert
      ...
      if (permissionGroup) {
        ...
        return dataManipulator.create({
          data: lodash.merge({
            ...
            "appType": sanitizeAppType(appTypeConvert)
          }),
  ...
  function getOnePermissionGroupByNameAndAppType({
    name,
    appTypeConvert
  }) {
  ...
  this.getPermissionByGroupNameAndAppType = function ({
    groups,
    appType
  }) {
